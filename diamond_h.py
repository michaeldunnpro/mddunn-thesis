...
###---------------------------------------###
os.chdir("/home/michael/Documents/Dev/RustBCA-Benchmarks/RustBCA")  # Change this to your RustBCA directory
###---------------------------------------###
...
'''
This example simulates the implantation of 1 keV H+ ions 
...
number_ions = 10000 # at least 10k are typically needed for decent results
...
# os.remove('input_fileenergy_loss.output')
# os.remove('input_fileimplantation_profile.output')
# os.remove('input_filereflection_coefficients.output')
# os.remove('input_filesputtering_yields.output')
# os.remove('examples/input_file.toml')